...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function update3DFromSketchpad() {
        ...
        if (style === 'wood-wood') {
            // خشمونيوم فاخر بلمعة ورنيش خفيفة واقعية
            cabMaterial = trackMat(new THREE.MeshPhysicalMaterial({ 
                color: 0x8b5a2b, 
                roughness: 0.35, 
                metalness: 0.1,
                clearcoat: 0.5,
        ...
        for (let idx = 0; idx < 36; idx++) {
            ...
            if (type === 'cabinet') {
                ...
                // الشفاط العلوي (Cooker Hood)
                const hoodMesh = new THREE.Mesh(hoodGeo, steelMaterial);
                hoodMesh.position.set(0, 1.25, -0.05);
